...
class Electronics_Appliances_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function electronics_appliances_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function electronics_appliances_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function electronics_appliances_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function electronics_appliances_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->electronics_appliances_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function electronics_appliances_load( $class ) {
