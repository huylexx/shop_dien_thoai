...
if ( ! class_exists( 'Electronics_Appliances_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Electronics_Appliances_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Electronics_Appliances_WPTT_WebFont_Loader( $url );
